export default function Footer() {
  return (
    <footer className="flex flex-wrap gap-20 justify-between w-full h-auto font-sans p-20 leading-10 max-md:p-10">
      <div className="flex flex-col justify-between">
        <div className="flex flex-col gap-3">
          ...
          <p>
            Get out there & discover your next <br className="max-md:hidden"/> slope, mountain &
            destination!
          </p>
        </div>
        <p className="opacity-70">Copyright 2019 MNTN, Inc. Terms & Privacy</p>
      </div>

      <div className="flex flex-wrap gap-20">
        <div>
          <p className="text-[#FBD784] text-lg">More on The Blog</p>
        ...
        <div>
          <p className="text-[#FBD784] text-lg">More on MNTN</p>
